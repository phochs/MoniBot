    ...
    create(callback) {
        try {
            this.messagesSent = new this.prometheus.client.Gauge({
                ...
                help: 'Discord total messages sent last minute, grouped by channel and user type',
            ...
            this.messagesDeleted = new this.prometheus.client.Gauge({
                ...
                help: 'Discord total messages deleted last minute, grouped by channel and user type',
                labelNames: ['channel', 'bot'],
            });
            ...
            this.messagesEdited = new this.prometheus.client.Gauge({
                ...
                help: 'Discord total messages edited last minute, grouped by channel and user type',
                labelNames: ['channel', 'bot'],
            });
            ...
            this.messageReactionsAdded = new this.prometheus.client.Gauge({
                ...
                help: 'Discord total reactions added last minute, grouped by channel and user type',
                labelNames: ['channel', 'bot'],
            });
            ...
            this.messageReactionsDeleted = new this.prometheus.client.Gauge({
                ...
                help: 'Discord total reactions deleted last minute, grouped by channel and user type',
                labelNames: ['channel', 'bot'],
            });
            ...
            this.messageMentions = new this.prometheus.client.Gauge({
                ...
                help: 'Discord total mentions last minute, grouped by channel, mention type and user type',
